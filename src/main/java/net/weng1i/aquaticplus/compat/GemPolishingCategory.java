...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Aquaticplus.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(Aquaticplus.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.aquaticplus.gem_polishing_station");
    }
